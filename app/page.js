...
const S = {
  ...
  nav: { position: 'fixed', bottom: 16, borderRadius: '20px', left: '50%', transform: 'translateX(-50%)', width: '95%', maxWidth: 460, display: 'flex', zIndex: 100, paddingBottom: 'env(safe-area-inset-bottom)' },
